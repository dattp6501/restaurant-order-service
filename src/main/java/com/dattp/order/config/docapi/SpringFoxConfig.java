package com.dattp.order.config.docapi;
  ...
  public Docket api() {
    return new Docket(DocumentationType.SWAGGER_2)
        .apiInfo(new ApiInfoBuilder()
            .title("Order restaurant service documentations")
            .description("Order restaurant service documentations")
            .contact(new Contact("Dat mars", "dattp.com", "dattp@gmailcom"))
            .version("0.0.1")
            .build()
        )
        .select()
        .apis(RequestHandlerSelectors.basePackage("com.dattp.order.controller"))
